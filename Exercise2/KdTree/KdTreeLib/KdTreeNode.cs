...
namespace KdTree
{
	...
	public class KdTreeNode<TKey, TValue>
	{
		...
		public HyperRect<TKey> LeftRect;
		public HyperRect<TKey> RightRect;
		...
		public override string ToString()
		{
			...
			sb.Append("LeftRec: " + LeftRect.MinPoint.ToString() + ", " + LeftRect.MaxPoint.ToString());
			sb.Append("RightRec: " + RightRect.MinPoint.ToString() + ", " + RightRect.MaxPoint.ToString());
